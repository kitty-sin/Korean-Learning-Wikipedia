...
14. **「外來語借詞」與「三麗鷗美食」兩大圖鑑專屬卡片 Emoji 批次精準配置 (2026-09-20)**：
    - **排查原因**：建構資料集時，原將每個單字的 `item.icon` 統一套用了該領域的 `domainIcon`（如 ☕、💻、🌸、🍲），導致整頁卡片重複千篇一律的圖標。
    - **三麗鷗美食全量 100 道料理**：
      - 逐一配置 59 款細分美食語意 Emoji（如 泡菜 🥬、韓式蒸蛋 🥚、三角飯糰 🍙、黑糖糖餅 🥞、韓式烤肉 🥩、炸雞 🍗、辣炒年糕 🌶️、黑醬炸醬麵 🥢、煎餃 🥟 等）。
    - **外來語借詞全量 242 詞**：
